...
class GINO(nn.Module):
    ...
    def __init__(
            ...
            gno_radius=0.033,
            in_gno_channel_mlp_hidden_layers=None,
            out_gno_channel_mlp_hidden_layers=None,
        ...
        # avoid bug when creating multiple instances
        if in_gno_channel_mlp_hidden_layers is None:
            in_gno_channel_mlp_hidden_layers = [80, 80, 80]
        if out_gno_channel_mlp_hidden_layers is None:
