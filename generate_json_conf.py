...
def block_postprocess(frame_pos_list, current_handle_pos_list,
    ...
    # print('frame_pos_list.device:', frame_pos_list[0].device)
    # print('current_handle_pos_list.device:', current_handle_pos_list[0].device)
    # print('handle_code_list:', handle_code_list)
...
def generate_from_code_for_gen_v3(motion_code, handle_ind_list, initial_mesh, fps):
    ...
    # print('initial_mesh device:', initial_mesh[0].device)
    current_handle_pos_list = initial_handle_pos
    ref_handle_pos = (current_handle_pos_list[handle_code_list.index(-1)] - current_handle_pos_list[handle_code_list.index(1)])
    ref_handle_pos = torch.tensor([ref_handle_pos[0], ref_handle_pos[2]])
    radius = torch.norm(ref_handle_pos).item()/2
    handle_orientation = compute_handle_orientation(ref_handle_pos)
